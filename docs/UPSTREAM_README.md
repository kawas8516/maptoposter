> **This is the original maptoposter README**, preserved from
> [originalankur/maptoposter](https://github.com/originalankur/maptoposter) and kept
> here because the CLI it documents still works exactly as described — this fork does
> not modify the rendering engine. For the AI theming layer built on top of it, see
